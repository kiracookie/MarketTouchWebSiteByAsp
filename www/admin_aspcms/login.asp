...
if action = "login" then
	...
	if rsObj(0)=1 then
		...
		Set rsObj=Conn.Exec("select IsAdmin, GroupStatus,GroupName, UserStatus, UserID, b.GroupMenu,GroupSort, LanguageID,adminrand,adminlanmu from {prefix}User as a, {prefix}UserGroup as b where LoginName='"&UserName&"' and a.GroupID=b.GroupID","r1")
		if not rsObj.Eof Then
			...
			Session("adminlanmu")=rsObj("adminlanmu")
		...
		<form method="post" action="?action=login" onsubmit="writeCookie('username',this.username.value, 1)">
            ...
            <dl>
			  ...
			  <dd>
               ...
               <a href="/">返回首页</a><!-- | <a href="http://www.4i.com.cn">上谷网络</a> | <a href="http://www.asp4cms.com">开源创新实验室</a>			   --></dd>
			  </dl>
			</div>
		</form>
