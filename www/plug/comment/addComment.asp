...
Sub addComment	
	...
	if commentReminded then 
		...
		for n=0 to ubound(mails)
			sendMail mails(n),setting.sitetitle,setting.siteTitle&setting.siteUrl&"--评论信息提醒邮件！","您的网站<a href=""http://"&setting.siteUrl&""">"&setting.siteTitle&"</a>有新的评论信息！<br>评论者："&Commentator&"<br>评论内容："&CommentContent&"<br>评论时间："&now()
		next
	end if
