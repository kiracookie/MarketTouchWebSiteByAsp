	...
	<div class="main">
		...
		<form method="post" action="?action=login" onsubmit="writeCookie('username',this.username.value, 1)">
            ...
            <dl>
					<dt></dt>
			  <dd>
                    <span style="color:#505050;font-size:12px;display:block">ASPCMS!是 <a href="http://www.4i.com.cn"  target="_blank" style="color:#315D80">上谷网络</a> 旗下 <a href="http://www.aspcms.com" target="_blank" style="color:#315D80">开源创新实验室</a> 推出的以企业建站为基础的专业建站系统，帮助其实现一站式服务。
</span>
                   
               <a href="/">返回首页</a> | <a href="http://www.cms88.com">ASPCMS模板尽在CMS88.COM</a></dd>
			  </dl>
			</div>
		</form>
