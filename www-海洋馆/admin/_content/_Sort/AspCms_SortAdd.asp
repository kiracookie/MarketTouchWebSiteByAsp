...
switch(t)
  ...
  <TR>
    ...
    <TD><INPUT class="checkbox" type="checkbox" checked="checked" name="SortStatus" value="1"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" checked="checked" name="NavStatus" value="1"/>&nbsp;&nbsp;顶部导航&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" name="NavStatus2" value="0"/>&nbsp;&nbsp;底部导航</TD>
  </TR>
  <% if wapMode=1 then %>
  <TR>
    <TD align=middle height=30>WAP菜单</TD>
    <TD><INPUT class="checkbox" type="checkbox" name="WapStatus" value="0"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" checked="checked" name="WapNavStatus" value="1"/>&nbsp;&nbsp;顶部导航&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" name="WapNavStatus2" value="0"/>&nbsp;&nbsp;底部导航</TD>
  </TR>
  <%end if%>
  <TR id="hid1">
