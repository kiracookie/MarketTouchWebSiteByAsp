...
switch(t)
  ...
  <TR>
    ...
    <TD><INPUT class="checkbox" type="checkbox" <% if SortStatus=1 then echo"checked=""checked"""%> name="SortStatus" value="1"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" <% if NavStatus=1 then echo"checked=""checked"""%> name="NavStatus" value="1"/>&nbsp;&nbsp;顶部导航&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" <% if NavStatus2=1 then echo"checked=""checked"""%> name="NavStatus2" value="1"/>&nbsp;&nbsp;底部导航
    </TD>
  </TR>
  <% if wapMode=1 then %>
  <TR>
    <TD align=middle height=30>WAP菜单</TD>
    <TD><INPUT class="checkbox" type="checkbox" <% if WapStatus=1 then echo"checked=""checked"""%> name="WapStatus" value="<%=WapStatus%>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" <% if WapNavStatus=1 then echo"checked=""checked"""%> name="WapNavStatus" value="<%=WapNavStatus%>"/>&nbsp;&nbsp;顶部导航&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="checkbox" type="checkbox" <% if WapNavStatus2=1 then echo"checked=""checked"""%> name="WapNavStatus2" value="<%=WapNavStatus2%>"/>&nbsp;&nbsp;底部导航
    </TD>
  </TR><%end if%>
  <TR id="hid1">
