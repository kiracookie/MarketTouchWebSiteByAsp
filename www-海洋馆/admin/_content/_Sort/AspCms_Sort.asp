...
<TABLE cellSpacing=0 cellPadding=3 width="100%" align=center border=0 id="listtable">
  <TBODY>
  <TR class=list>
    <TD width=40 align="center" class=biaoti>选择</TD>
    <TD width=50 align="center" class=biaoti>编号</TD>
    <TD width=220 height=28 align="center" class=biaoti><span class="searchzone">分类名称</span></TD>
    <TD width=80 align="center" class=biaoti><span class="searchzone">类型</span></TD>
    <TD width=160 align="center" class=biaoti><span class="searchzone">链接</span></TD>
    <TD width=60 align="center" class=biaoti><span class="searchzone">排序</span></TD>
    <TD width=30 align="center" class=biaoti><span class="searchzone">状态</span></TD>
    <TD width=30 align="center" class=biaoti><span class="searchzone">Nav1</span></TD>
    <TD width=30 align="center" class=biaoti><span class="searchzone">Nav2</span></TD>
    <%if wapMode=1 then %>
    <TD width=30 align="center" class=biaoti><span class="searchzone">wap</span></TD>
    <TD width=30 align="center" class=biaoti><span class="searchzone">Wap1</span></TD>
    <TD width=30 align="center" class=biaoti><span class="searchzone">Wap2</span></TD>
    <%end if%>
    <TD width=200 align="center" class=biaoti><span class="searchzone">操作</span></TD>
    </TR>
	<tr bgcolor=""#ffffff"" align=""center"" onMouseOver=""this.bgColor='#CDE6FF'"" onMouseOut=""this.bgColor='#FFFFFF'""><%sortList(0)%></tr>
    </TBODY></TABLE>
</DIV>
<DIV class=piliang>
